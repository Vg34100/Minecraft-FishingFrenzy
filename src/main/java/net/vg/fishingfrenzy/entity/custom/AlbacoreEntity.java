...
public class AlbacoreEntity extends SchoolingFishEntity {
    public final AnimationState idleAnimationState = new AnimationState();
    private int idleAnimationTimeout = 0;

    public AlbacoreEntity(EntityType<? extends SchoolingFishEntity> entityType, World world) {
    ...
    protected void dropLoot(DamageSource damageSource, boolean causedByPlayer) {
        ...
        this.dropItem(ModItems.RAW_ALBACORE);
    ...
    public static DefaultAttributeContainer.Builder createAlbacoreAttributes() {
